...
This is an arduino library that implements a binary packet-based `communication protocol <https://wiki.nulltek.xyz/docs/protocols/npc>`_ on top of the arduino Serial library.
